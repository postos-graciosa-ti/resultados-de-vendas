...
def calcular_dados_indicador(indicador, realizado, filial_codigo):
    ...
    if nivel_batido < 2:
        ...
        necessario_dia, dias_restantes = calcular_necessario_por_dia(
            realizado, proxima_meta_valor
        )
            ...
            content=ft.Column(
                ...
                controls=[
                    ...
                    ft.DataTable(
                        ...
                        columns=[
                            ft.DataColumn(
                                ft.Text("Indicador", weight=ft.FontWeight.BOLD)
                            ),
                            ft.DataColumn(
                                ft.Text("Realizado", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                            ft.DataColumn(
                                ft.Text("Meta 1", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                            ft.DataColumn(
                                ft.Text("Meta 2", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                            ft.DataColumn(
                                ft.Text("Meta 3", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                            ft.DataColumn(
                                ft.Text("Proxima Meta", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                            ft.DataColumn(
                                ft.Text("Nec./Dia", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                        ],
                        rows=rows_diario,
                ...
                controls=[
                    ...
                    ft.DataTable(
                        ...
                        columns=[
                            ...
                            ft.DataColumn(
                                ft.Text("Meta Atingida", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                            ft.DataColumn(
                                ft.Text("Fator 1", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                            ft.DataColumn(
                                ft.Text("Fator 2", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                            ft.DataColumn(
                                ft.Text("Fator 3", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                            ft.DataColumn(
                                ft.Text("Fator Atual", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                            ft.DataColumn(
                                ft.Text("Comissao", weight=ft.FontWeight.BOLD),
                                numeric=True,
                            ),
                        ],
                        rows=rows_comissao,
                    ...
                    rows_diario.append(
                        ft.DataRow(
                            cells=[
                                ...
                                ft.DataCell(
                                    ft.Text(
                                        f"{metas[0]:,.2f}", color=ft.Colors.GREY_700
                                    )
                                ),
                                ft.DataCell(
                                    ft.Text(
                                        f"{metas[1]:,.2f}", color=ft.Colors.GREY_700
                                    )
                                ),
                                ft.DataCell(
                                    ft.Text(
                                        f"{metas[2]:,.2f}", color=ft.Colors.GREY_700
                                    )
                                ),
                    ...
                    rows_comissao.append(
                        ft.DataRow(
                            cells=[
                                ...
                                ft.DataCell(
                                    ft.Text(
                                        f"{fatores[0]:.3f}", color=ft.Colors.GREY_600
                                    )
                                ),
                                ft.DataCell(
                                    ft.Text(
                                        f"{fatores[1]:.3f}", color=ft.Colors.GREY_600
                                    )
                                ),
                                ft.DataCell(
                                    ft.Text(
                                        f"{fatores[2]:.3f}", color=ft.Colors.GREY_600
                                    )
                                ),
                ...
                content=ft.Column(
                    ...
                    controls=[
                        ...
                        ft.Row(
                            ...
                            controls=[
                                ft.FilledButton(
                                    "Salvar", icon=ft.Icons.SAVE, on_click=salvar_cfg
                                ),
                                ft.OutlinedButton(
                                    "Testar Conexao",
